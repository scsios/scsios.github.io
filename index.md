...
Siri は連絡先の登録に対応していないので、 iPhone のキーボード操作が苦手な人にとって、連絡先を登録することはかなりの難関となる。
...
起動したとき、最初に一瞬オーディオ録音の画面が出るが、無視して良い。この画面は、Siriでショートカットを起動した場合に、電話番号等の音声入力時に「テキストは何ですか」と聞いてくるのを避けるための措置。
{:.note}
