...
起動したとき、最初に一瞬オーディオ録音の画面が出るが、無視して良い。この画面は、 Siri でこのショートカットを起動した場合に、電話番号等の音声入力時に「テキストは何ですか」と聞いてくるのを避けるための措置。もっとスマートな方法があれば [作者](mailto:gusni.kantu@gmail.com) に教えてほしい。
{:.note}
