...
以下のショートカットは iPhone にデフォルトで備わっているOCR機能を使い、 Siri だけで操作して読み上げを聞くことができる。
電話をかける機能以外はオフラインでも利用可能。
...
VoiceOver を常にオンにしている人用
:[「電話番号を読んで」のショートカット](https://www.icloud.com/shortcuts/65e2cb7a1f30440fb27016f0fa525b69){:target=”_blank”}を iPhone にダウンロードする。
...
- それ以外の答え（「いいえ」など）を言った場合は、その番号を連絡先に登録するかどうか聞かれる。
  ...
  - それ以外の答え（「いいえ」など）を言った場合、他の電話番号が認識されていれば、その番号の読み上げから同様のことを繰り返す。他の番号がなければ動作終了。  
